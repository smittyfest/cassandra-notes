...
<p>When you introduce replication to this master-slave architecture, you have to decide how to handle failover. Maybe you build an automatic process to perform failover, maybe its a manual process, where someone notices the database has gone down and pushes a button to switch-over to the failover service.
